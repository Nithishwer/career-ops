...
English is the only supported language. Always read from the root `modes/` directory and generate all reports, CVs, cover letters, tracker notes, and outreach in English, even when a JD is written in another language.
